...
# Build Marvin + BBC BASIC for BeanZee target
...
MARVIN_MODULES="console_usb um245r monitor hex messages"
...
echo "  BHOOK.asm"
z88dk-z80asm -l -m -o"$OUTDIR/BHOOK.o" "$SHARED_DIR/BHOOK.asm"

# ---- Target modules ----

TARGET_MODULES="ENTRY BMOS"

echo ""
echo "Assembling target modules..."
for module in $TARGET_MODULES; do
    echo "  $module.asm"
    z88dk-z80asm -l -m -I"$REPO_DIR" -o"$OUTDIR/$module.o" "$SCRIPT_DIR/$module.asm"
done
