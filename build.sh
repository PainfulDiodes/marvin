...
minimal_modules_for_target() {
    case $1 in
        ...
        beanboard)
            ...
            MINIMAL_MODULES="console_beanboard console_select drivers/um245r monitor hex drivers/hd44780 drivers/keymatrix drivers/ra8875 drivers/ra8875_gpio messages_beanboard"
            ;;
        beandeck)
            MINIMAL_ENTRY="entry_beandeck_minimal"
            MINIMAL_MODULES="console_beandeck console_select drivers/um245r monitor hex drivers/keymatrix drivers/ra8875 drivers/ra8875_spi messages"
            ;;
    esac
}
